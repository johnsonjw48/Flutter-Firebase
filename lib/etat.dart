// ignore_for_file: must_be_immutable, unused_local_variable, unused_element, deprecated_member_use, duplicate_ignore, unused_import, unnecessary_null_comparison, null_check_always_fails, import_of_legacy_library_into_null_safe
...
// CIRCONSTANCES A
                                Positioned(top: 111, left:131,
                                  child:Text(accident.c1,
                                    style: TextStyle(fontFamily: 'AirbnbCerealBold', fontSize: 6, fontWeight: FontWeight.bold, color: Colors.black),),
                                ),
                                Positioned(top: 122, left:131,
                                ...
                                Positioned(top: 315, left: 131,
                                  child:Text(accident.c17,
                                    style: TextStyle(fontFamily: 'AirbnbCerealBold', fontSize: 6, fontWeight: FontWeight.bold, color: Colors.black),),
                                ),
                                Positioned(top: 325, left: 132,
                                  child:Text("N",
                                    style: TextStyle(fontFamily: 'AirbnbCerealBold', fontSize: 6, fontWeight: FontWeight.bold, color: Colors.black),),
                                ),
